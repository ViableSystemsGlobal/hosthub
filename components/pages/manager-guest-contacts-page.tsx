...
import { Plus, Edit, Mail, Phone, Calendar, Building2, Search } from 'lucide-react'
...
export function ManagerGuestContactsPage() {
  ...
  const handleConvertToBooking = (contact: any) => {
    router.push(`/manager/bookings/new?guestContactId=${contact.id}`)
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">Manage leads, inquiries, and guest contacts for your properties</p>
        </div>
        <Button onClick={() => router.push('/manager/guest-contacts/new')}>
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <Button
                className="mt-4"
                onClick={() => router.push('/manager/guest-contacts/new')}
              >
                <Plus className="mr-2 h-4 w-4" />
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => router.push(`/manager/guest-contacts/${contact.id}`)}
                          >
